// Auto-generated with Adafruit-GFX fontconvert from Source Serif 4 (SIL Open Font License). Source: Google Fonts (github.com/google/fonts).
...
#ifndef FONT_SOURCE_SERIF4_H
#define FONT_SOURCE_SERIF4_H
